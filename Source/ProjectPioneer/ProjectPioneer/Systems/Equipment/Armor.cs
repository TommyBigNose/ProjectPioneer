namespace ProjectPioneer.Systems.Equipment
{
	public class Armor : IEquipment
	{
		...
		public string ImageName => Name.Replace(" ", "").Replace("\'", "");
		...
		public Armor(int id, string name, string description, EquipmentType equipmentType, Stats stats)
		{
			_id = id;
			_name = name;
		...
		{
			return _stats.Level * Constants.ArmorCostScaling;
		}
